...
using WarehouseManger.Client.Infrastructure.Managers;
...
using WarehouseManger.Client.Infrastructure.Managers.ExtendedAttribute;
using WarehouseManger.Domain.Entities.ExtendedAttributes;
using WarehouseManger.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace WarehouseManger.Client.Extensions
{

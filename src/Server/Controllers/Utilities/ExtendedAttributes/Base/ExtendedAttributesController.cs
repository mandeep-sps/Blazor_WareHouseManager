...
using WarehouseManger.Application.Features.ExtendedAttributes.Commands.Delete;
...
using WarehouseManger.Application.Features.ExtendedAttributes.Queries.GetById;
using WarehouseManger.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace WarehouseManger.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
